...
<html>
  <head>
    ...
    <link href="http://172.31.75.246/S2015150290/mymaven/css/input.css" rel="stylesheet" type="text/css" media="all" />
  </head>
  <body onload="createCode()">
  <div class="form">
    <form action="/S2015150290/AddServlet" method="post">
  ...
  <script type="text/javascript" src="http://172.31.75.246/S2015150290/mymaven/js/check.js"></script>
  <script language="javascript" type="text/javascript" src="http://172.31.75.246/S2015150290/mymaven/js/validatecode.js"></script>
  </body>
</html>
